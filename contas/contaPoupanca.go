...
func (conta *ContaPoupanca) Transferir(valorDaTransferencia float64, contaDestino *ContaCorrente) (string, float64) {
...
func (conta *ContaPoupanca) GetSaldo() (string, float64) {
	return "Seu saldo da conta poupança é de:", conta.saldo
}
